...
const HandMetal = createLucideIcon("hand-metal", __iconNode$f);
const __iconNode$e = [
...
const Puzzle = createLucideIcon("puzzle", __iconNode$9);
const __iconNode$8 = [
...
const TableProperties = createLucideIcon("table-properties", __iconNode$6);
const __iconNode$5 = [
